...
public class BankAccount {
	...
	public void deposit(BigDecimal amount) {
		...
		//add transction to the list of transactions by account with transaction type DEPOSIT
	...
	public void withdraw(BigDecimal amount) {
		//throw an exception because the amount equals or less to zero or balance less to amount and exit
		...
		//add transction to the list of transactions by account with transaction type WITHDRAWAL
